...
#Regression Model for 24-48hrs pain
```{r}
spinelm2 <- lm(postOp24_48Hrs~
               Genetics +
              PatientGender +
              PatientAge +
              PatientWeight +
...
spinelm2step <- step(spinelm2, trace = 0)
summary(spinelm2step)

```

#Regression Model for 48-72hrs pain
```{r}
spinelm3 <- lm(postOp48_72Hrs~
               Genetics +
              PatientGender +
              PatientAge +
              PatientWeight +
...
spinelm3step <- step(spinelm3, trace = 0)
summary(spinelm3step)
...
chestlm2step <- step(chestlm2, trace = 0)
summary(chestlm2step)
...
chestlm3step <- step(chestlm3, trace = 0)
summary(chestlm3step)
